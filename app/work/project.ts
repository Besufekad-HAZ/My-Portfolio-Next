export const projects = [
  ...
  },
  {
    ...
    title: "Vespa Rentals",
    description:
      "Full-stack motorcycle rental app: browse and reserve Vespas, or list your own for rent. Built with a React (Next.js) frontend and Ruby on Rails API. Features include JWT auth, public motorcycle catalog, user-scoped reservations, and owner dashboard for managing listings. Deploy frontend and backend separately (e.g. Vercel + Render).",
    stack: [
      { name: "Next.js" },
      { name: "TypeScript" },
      { name: "Tailwind CSS" },
